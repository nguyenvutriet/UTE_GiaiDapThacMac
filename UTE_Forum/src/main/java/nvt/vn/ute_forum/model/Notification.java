...
public class Notification {
    ...
    @Column(name = "notificationtype", nullable = false, columnDefinition = "VARCHAR(255) CHECK (notificationtype IN ('VOTE_FORUM_POST_NOTIFICATION', 'COMMENT_FORUM_POST_NOTIFICATION', 'REPLY_COMMENT_FORUM_POST_NOTIFICATION', 'NEW_ANNOUNCEMENT_NOTIFICATION'" +
